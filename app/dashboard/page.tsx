      ...
      <div className="space-y-4 text-[13px]">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-800">
              <Activity className="w-3.5 h-3.5 text-green-600" />
              <span className="text-[11px] font-medium text-green-700 dark:text-green-400">System Online</span>
            </div>
            <div className="text-[11px] text-muted-foreground bg-muted px-3 py-1.5 rounded">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
          {[
            ...
            >
              <Card className={`hover:shadow-sm transition-all border ${stat.borderColor}`}>
              ...
              <Card>
                ...
                <CardContent className="p-3 pt-1 grid grid-cols-2 gap-2">
                  {[
                    ...
                    <button
                      key={i}
                      className="flex items-center gap-2 p-2 border rounded hover:bg-muted/50 hover:border-green-300 transition-all text-left group"
                    >
              ...
              <Card className="border-red-200 dark:border-red-800">
                <CardHeader className="p-3 pb-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="destructive" className="text-[9px] px-1.5 py-0.5 h-5">3 New</Badge>
                  </div>
                </CardHeader>
                <CardContent className="p-3 pt-1 space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-2 p-2 bg-red-50 dark:bg-red-900/10 rounded border border-red-100 dark:border-red-900/20">
            ...
            <CardContent className="p-3 pt-1">
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-8 xl:grid-cols-10 gap-2">
                {[
                  ...
                  <div key={i} className="p-2 border rounded hover:shadow-sm hover:border-green-300 transition-all cursor-pointer group">
