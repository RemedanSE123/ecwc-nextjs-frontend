        ...
        <CardContent className="p-4 space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 border-b border-gray-300 pb-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, vehicleEquipmentType: e.target.value }))}
              />
            </div>
            <div className="space-y-2">
              <Label className="flex flex-col text-[10px] leading-tight">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, vehicleEquipmentCapacity: e.target.value }))}
              />
            </div>
            <div className="space-y-2">
              <Label className="flex flex-col text-[10px] leading-tight">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, morningStartTime: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  <Label className="flex flex-col text-[10px] leading-tight">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, morningEndTime: e.target.value }))}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, afternoonStartTime: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  <Label className="flex flex-col text-[10px] leading-tight">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, afternoonEndTime: e.target.value }))}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, eveningStartTime: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  <Label className="flex flex-col text-[10px] leading-tight">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, eveningEndTime: e.target.value }))}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-2 border-b border-gray-300 pb-6">
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, totalWorkingHours: e.target.value }))}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 border-b border-gray-300 pb-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, kmReadingOrEngineHours: e.target.value }))}
              />
            </div>
            <div className="space-y-2">
              <Label className="flex flex-col text-[10px] leading-tight">
          ...
          <div className="space-y-2 border-b border-gray-300 pb-6">
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, projectWorkedOn: e.target.value }))}
            />
          </div>
          ...
          <div className="space-y-4 border-b border-gray-300 pb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  className={lineInput}
                  value={formData.siteManagerSupervisor}
                  onChange={(e) => setFormData(prev => ({ ...prev, siteManagerSupervisor: e.target.value }))}
                />
              </div>
              <div className="space-y-2">
                <Label className="flex flex-col text-[10px] leading-tight">
